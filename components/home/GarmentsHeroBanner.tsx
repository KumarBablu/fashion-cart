...
export default function GarmentsHeroBanner({
  ...
  return (
    <section className="relative min-h-[440px] sm:min-h-[480px] lg:min-h-[520px] text-white overflow-hidden border-b border-[#E7DFD5] shadow-2xl flex flex-col justify-between">
            ...
            return (
              ...
              >
                <Link
                  ...
                  prefetch={true}
                  className="block w-full rounded-3xl overflow-hidden backdrop-blur-xl bg-[#141416]/55 border-0 shadow-[0_30px_70px_rgba(0,0,0,0.75)] p-4 sm:p-5 space-y-3.5 transition-all group cursor-pointer"
                >
                  {/* Top Badge */}
                  <div className="flex items-center justify-between">
                    <span className="px-3.5 py-0.5 rounded-full bg-[#C59B27]/20 text-[10px] font-bold uppercase tracking-wider text-[#F3E5AB]">
                      {s.lookbookBadge}
                    </span>
